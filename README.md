...
Deployed URL: https://somecallmetom.github.io/DnD/
...
There is a [source/raw_html](./source/raw_html) folder that gets copied into the build folder in CI. This lets you host arbitrary HTML outside of quartz. 
https://somecallmetom.github.io/DnD/raw-html-test.html
